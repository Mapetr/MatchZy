    ...
    public partial class MatchZy : BasePlugin
    {
        ...
        public int
            minimumReadyRequired =
                2; // Number of ready players required start the match. If set to 0, all connected players have to ready-up to start the match.
        ...
        public override void Load(bool hotReload)
        {
            ...
            RegisterEventHandler<EventPlayerTeam>((@event, info) =>
            {
                ...
                {
                    Server.NextFrame(() => { player.SwitchTeam(playerTeam); });
                }
            ...
            RegisterEventHandler<EventPlayerHurt>((@event, info) =>
            {
                ...
                if (isPractice && victim!.IsBot)
                {
                    ...
                    PrintToPlayerChat(attacker!,
                        Localizer["matchzy.pracc.damage", damage, victim.PlayerName, postDamageHealth]);
                    return HookResult.Continue;
                }
            ...
            RegisterEventHandler<EventPlayerBlind>((@event, info) =>
            {
                ...
                if (attacker!.IsValid)
                {
                    ...
                    PrintToPlayerChat(attacker,
                        Localizer["matchzy.pracc.blind", player!.PlayerName, roundedBlindDuration]);
                }
